...
module.exports = {
    ...
    loginProcess: (req, res) => {
        ...
        if (errors.isEmpty()) {
            ...
            <p styles="text-align: justify;">Hola ${ name }, elegiste el color: ${ colorNombre },
             tu email es: ${ email } y tu edad es: ${ edad } años.</p>
            </article>
            <article class="linkeo">
            <p>Ingresa <a href="/user">acá</a> para darte la bienvenida.</p>
            </article>
            </section>
            </main>
            </body>
